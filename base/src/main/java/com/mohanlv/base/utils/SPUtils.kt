...
object SPUtils {
    ...
    fun getString(key: String, default: String? = null): String? = sp?.getString(key, default) ?: default
    ...
    fun getBoolean(key: String, default: Boolean = false): Boolean = sp?.getBoolean(key, default) ?: default
    fun putBoolean(key: String, value: Boolean) { sp?.edit { putBoolean(key, value) } }
